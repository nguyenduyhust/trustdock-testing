...
const SelectKYC: NextPage = () => {
  ...
  return (
    <Box>
      <Typography variant="h5">Start KYC</Typography>
      <Box marginTop={1}>
        <TextField label="Plan" select fullWidth variant="outlined" value={plan} onChange={onPlanChange}>
      ...
      <Box marginTop={1}>
        <Button variant="contained" onClick={onSubmit} disabled={!isValid}>Submit</Button>
      </Box>
    </Box>
  )
}
